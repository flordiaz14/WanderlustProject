...
function ProductCityPage() {
  ...
  return (
    <div className="products--city__page">
      <Search />
      <h2 className="products--city__page--title">
        {!listProducts ? 0 : listProducts?.length} Alojamientos encontrados para
        el {searchParam.get("start")} hasta el {searchParam.get("end")}
      </h2>
...
export default ProductCityPage;
