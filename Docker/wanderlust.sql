-- El usuario se crea a lo ultimo para darle permiso a esta nueva base
--------------------------------------------------------
...
-- Usuario y clave
-- -----------------------------------------------------
CREATE USER 'webapp'@'localhost' IDENTIFIED BY 'thepasswordtouserwebapp';
GRANT ALL PRIVILEGES ON `wanderlust` . * TO 'webapp'@'localhost';
FLUSH PRIVILEGES;